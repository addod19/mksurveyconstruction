...
class ExpendituresTest < ApplicationSystemTestCase
  ...
  test "should create expenditure" do
    ...
    fill_in "Category", with: @expenditure.category
    fill_in "Notes", with: @expenditure.notes
    fill_in "Spent on", with: @expenditure.spent_on
    fill_in "Title", with: @expenditure.title
